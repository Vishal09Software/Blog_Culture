                                ...
                                <form action="{{ '/blog_post' }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="my-select" class="form-control" name="category_name">
                                            <option selected disabled>-------------- Blog Category Select -------------
                                            </option>
                                    ...
                                    <textarea name="paragraph" id="editor1"></textarea>
                                    <div style="color: red">
                                        @error('paragraph')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <tbody>
                                        @foreach ($blog as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->date }}</td>
                                                <td>{{ $data->image }}</td>
                                                <td> <a href="{{ '/blog_post/edit/' . $data->id }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                </td>
                                                <td><a href="{{ '/blog_post/delete/' . $data->id }}"><i
