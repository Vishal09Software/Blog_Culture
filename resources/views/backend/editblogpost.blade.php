...
@section('main-container')
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
                                            ...
                                            <div class="breadcomb-ctn">
                                                <h2>Blog Category</h2>
                                                <p>Welcome to <span class="bread-ntd">Admin Template</span></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                ...
                                @if ($errors->any())
                                @endif
                                <form action="{{ '/blog_post/update_data/' . $blog->id }}" method="POST"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf

                                    <label for="">Blog Heading</label>
                                    <input type="text" name="heading" placeholder="Blog Heading "
                                        value="{{ $blog->heading }}">
                                    <div style="color: red">
                                        @error('heading')
                                            {{ $message }}
                                    ...
                                    <label for="my-select">Blog Categroy</label>
                                    <select id="my-select" class="form-control" name="category_name"
                                        ...
                                        @foreach ($category as $cat)
                                            <option value="{{ $cat->category_name }}"
                                                {{ $cat->category_name == $blog->category_name ? 'selected' : '' }}>
                                                {{ $cat->category_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <label for="my-input">Blog Details</label>
                                    <textarea name="paragraph" id="editor1">{{ $blog->paragraph }}</textarea>
                                    <div style="color: red">
                                                @error('paragraph')
        {{ $message }}
    @enderror
    ...
    @enderror
                                            ...
                                            <img src="{{ asset('backend/images/' . $blog->image) }}"
