            ...
            <div class="row admin ">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                ...
                                <form action="{{ '/category' }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <label for="">Blog Categroy</label>
                                    <input type="text" name="category_name" placeholder="Add Categroy Name">
                                    <div style="color: red">
                                        @error('category_name')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center" style="margin-bottom:1px;">
                                    ...
                                    <tbody>
                                        @foreach ($show as $data)
                                            <tr>
                                                ...
                                                <td> <a href="{{ '/category/edit/' . $data->id }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                </td>
                                                <td><a href="{{ '/category/delete/' . $data->id }}"><i
